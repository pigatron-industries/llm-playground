...
- Keep narration grounded, second person, present tense. Keep writing simple and natural, like it was written by a human.
...
In descriptions sent to tools to create locations/characters/items:
- Decriptions are for you only, they should be short and stick to facts only. Keep writing simple and plain, like it was written by a human.
